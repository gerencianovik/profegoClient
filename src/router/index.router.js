...
const { mostrar, login, registro, CerrarSesion, mostrarLoginTeacher, mostrarRegistroTeacher, mostrarRegistroStudents, mostrarLoginStudents, loginEstudiante, registroEstudiante, somos, funciona, seguridad, contactos, listaPoliticas } = require('../controller/index.controller');
...
router.get('/policyList', listaPoliticas)
